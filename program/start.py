...
@Client.on_message(command(["start", f"start@KTOMUISCBOT"]) & filters.private & ~filters.edited)
...
@Client.on_message(command(["بوت", f"help@KTOMUISCBOT"]) & filters.group & ~filters.edited)
    ...
    await message.reply_photo("https://telegra.ph/file/2a570e5771e601de624bc.jpg", caption=f"""MisTiri .\n\n▹￤ لصنع مثل هذا البوت تواصل مع مطور السورس\n\n▹￤[قناة السورس](t.me/{UPDATES_CHANNEL})\n▹￤[تحديثات السورس](t.me/{UPDATES_CHANNEL})\n▹￤[مطور السورس](t.me/l_IIIIIIl)\n▹￤[مبرمج السورس](t.me/l_IIIIIIl)**""", 
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [   InlineKeyboardButton("‹ قناة السورس ›", url="https://t.me/{UPDATES_CHANNEL}"),
...
@Client.on_message(
    command(["فحص", f"alive@KTOMUISCBOT"]) & filters.group & ~filters.edited
)
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("‹ قناة السورس ›", url=f"https://t.me/{UPDATES_CHANNEL}"),
                InlineKeyboardButton("‹ مطور البوت ›", url=f"https://t.me/l_IIIIIIl"),
            ]
        ]
    )

    alive = f"**▪️ اهلا عزيزي {message.from_user.mention()}**\n\n**▪️ شكرا لاضافتكم لبوت كتو في حال وجود اي مشكله او استفسار راسل مطور البوت**"
...
@Client.on_message(command(["بنك", f"ping@KTOMUISCBOT"]) & ~filters.edited)
...
@Client.on_message(command(["الحاله", f"uptime@KTOMUISCBOT"]) & ~filters.edited)
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "مطور البوت", url=f"https://t.me/l_IIIIIIl"
                            ),
                            InlineKeyboardButton(
...
@Client.on_message(command(["Kstop", f"Kstop@KTOMUISCBOT", "تعطيل المميزات"]) & ~filters.edited)
...
@Client.on_message(filters.command("كتو طفي المميزات", [".", ""]) & ~filters.edited)
@authorized_users_only
...
@Client.on_message(command(["Kstart", f"Kstart@KTOMUISCBOT"]) & ~filters.edited)
@authorized_users_only
...
@Client.on_message(filters.command("كتو فعلي المميزات", [".", ""]) & ~filters.edited)
@authorized_users_only
